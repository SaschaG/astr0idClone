...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("astr0idClon", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("astr0idClon", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "astr0idClon";
		app.meta["name"] = "astr0idClon";
